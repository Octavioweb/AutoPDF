...
car1.addEventListener("click", async function() {
    selectedCar = "Car1"; 
    updateHeaderAndButtonsVisibility("Vehículo: Tang ev");
});
  
car2.addEventListener("click", async function() {
    selectedCar = "Car2"; 
    updateHeaderAndButtonsVisibility("Vehículo Han ev");
});

car3.addEventListener("click", async function() {
    selectedCar = "Car3"; 
    updateHeaderAndButtonsVisibility("Vehículo: Yuan Plus ev");
});
...
sendBtn.addEventListener('click', async function() {
    ...
    if (message) {
        ...
        try {
            const response = await fetch('https://mmm-2rrb.onrender.com/ask', {
                method: 'POST',
                headers: {
